			...
			else 
			{
	            ...
	            $Popupwfb = $Popupwfb.'</div>';					    
		         ...
		         $Popupwfb = $Popupwfb.'<div id="easy" class="fancybox-content-inside"  style="background:'.$bg_color.';color:'.$color.';padding:15px;">';
				   $Popupwfb = $Popupwfb.'<p id="imgsection" style="width:40%;margin:5px;float: left;border: 1px solid black;margin: 5px;padding: 10px;">';
				   $Popupwfb = $Popupwfb.'<img src='.$image.'>';
				   $Popupwfb = $Popupwfb.'</p>';
				   $Popupwfb = $Popupwfb.'<p id="textsection" style="width:50%;margin:5px;float: left;margin: 5px;padding: 10px;">'.$content.'</p>';
...
<form>
		...
		<input type="hidden" name="oscimp_hidden" value="Y">
			<table class="form-table">
				<th>
					<label class="spu-label" for="spu-color"><?php _e( 'Popup Display Page Type','wp-easy-popup'); ?></label>
					</th>
					<td>	
		...
		<tr>
				...
				<tr valign="top">
					...
					<tr valign="top">
						...
						<td>
							<input  name="start_date" id="datepicker1"  type="text" class="small" value="<?php echo $start_date; ?>" />
					...
					<tr valign="top">
						...
						<td>
							<input  name="end_date"  id="datepicker" type="text" class="" value="<?php echo $end_date; ?>" />
...
//	$prfx_stored_meta = get_post_meta( $post->ID );
  ...
  if(!is_numeric($popup_timeout)) 
			{
				update_post_meta($post_id,'popup_timeout', 500); 
			}
      else
			{
